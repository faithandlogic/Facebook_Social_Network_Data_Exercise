...
public class DirectedGraph<T> implements GraphInterface<T> {
    ...
    /**
     * Removes a vertex and all edges incident to it from the graph.
     * 
     * @param vertexLabel The object that labels the vertex to be removed.
     * @return True if the vertex is removed, or false if not (e.g. if the vertex
    ...
    public boolean removeVertex(T vertexLabel) {
        ...
        if (vertex != null) {
            ...
            while (neighbors.hasNext()) {
                VertexInterface<T> nextNeighbor = neighbors.next();
                nextNeighbor.disconnect(vertex);
            } // end while
     ...
     * 
     * @param begin The object that labels the origin vertex of the edge to be
     *              removed.
     * @param end   The object that labels the end vertex of the edge to be removed.
     * @return True if the edge is removed, or false if not (e.g. if the edge
     *         doesn't exist in the graph).
     */
